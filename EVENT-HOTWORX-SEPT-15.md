...
**No URLs in any caption.** The permanent event page is still a 404 until PR #64
merges, so the posts carry the poster and the phone number instead. The Google
Business posts use a *Call now* button, which needs no URL and matches sign-ups
going to the office line anyway.
