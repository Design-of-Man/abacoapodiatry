...
(function () {
  ...
  var TOPICS = [
    ...
    },
    {
      ...
      a: "<strong>Jupiter</strong> (4601 Military Trail): Mon–Thu 8 AM–5 PM · Fri 8 AM–2 PM. Closed weekends.<br><strong>Palm Beach Gardens</strong> (11380 Prosperity Farms Rd): Mon–Wed 8 AM–4:30 PM · Fri 8 AM–2 PM — closed Thursday and Sunday. Saturday is by concierge appointment only.<br>Call " + PHONE_HTML + " to schedule at either office.",
      chips: ["Book an appointment", "Where are you located?"]
    },
    {
      id: "heel",
