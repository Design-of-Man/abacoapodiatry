...
### The flyer is print-ready

The QR points at **`https://jupiterlaser.com/hotworx/`** — the real domain, which
serves this site (the cutover completed 2026-08-18). The flyer also prints
`jupiterlaser.com/hotworx` in text for anyone who would rather type than scan.

To regenerate the assets (requires `pip install Pillow segno`):

```
python3 _src/event_hotworx.py
...
## 8. Scheduled social plan (Post Bridge)

Media is already uploaded to Post Bridge. Times are US Eastern; the UTC column is
what goes in `scheduled_at`.

| When (ET) | UTC | Accounts | Image |
|---|---|---|---|
| Fri Sep 11, 4:00 PM | `2026-09-11T20:00:00Z` | Abacoa Facebook, Abacoa Instagram | poster |
| Fri Sep 11, 4:15 PM | `2026-09-11T20:15:00Z` | Abacoa Google Business ×2 (Jupiter + PBG) | poster |
| Fri Sep 11, 4:15 PM | `2026-09-11T20:15:00Z` | RegenOrtho Palm Beach Google Business | poster |
| Sat Sep 12, 10:00 AM | `2026-09-12T14:00:00Z` | Abacoa Facebook, Abacoa Instagram | "Free. Tuesday. 4 PM." |
| Mon Sep 14, 5:00 PM | `2026-09-14T21:00:00Z` | Abacoa Facebook, Abacoa Instagram | "Tomorrow." |
| Tue Sep 15, 9:00 AM | `2026-09-15T13:00:00Z` | Abacoa Facebook, Abacoa Instagram | "Today. 4 PM." |

**Post Bridge account IDs:** Abacoa Facebook `84729` · Abacoa Instagram `84730`
(`bunionboss_abacoapodiatry`) · Abacoa Google Business `95862` and `84731` ·
RegenOrtho Google Business `84732` · Abacoa TikTok `96006`.

**Media IDs:** poster `687f3c34-0524-4cba-97ce-7b08c15549fa` · "Free"
`4a876c4d-0920-422e-b17a-02bd51b3916a` · "Tomorrow"
`b400c81b-d74b-4bc2-998e-c39ef3f8964b` · "Today"
`5376ccf2-9d7f-4df7-8a68-b9c9fbbe9b68`.

### Notes on this plan

**Captions carry no URL, by choice.** Instagram captions can't hold a live link
anyway, and the Google Business posts use a *Call now* button, which matches
sign-ups going to the office line. Facebook's first comment is the place to drop
`jupiterlaser.com/hotworx` if you want the link in the thread.

**Post Bridge publishes a standard Google Business update, not a native Event
post.** It does not expose the start/end date fields, so these will not carry the
event date badge. The true Event post — with the date range — still has to be
created by hand in the Google Business dashboard using the copy in section 2.
Worth doing both.

**TikTok is connected** (`abacoapodiatry`) but is deliberately left out. A static
poster makes a weak TikTok post; that one is worth waiting for the video Rose
offered to send.
